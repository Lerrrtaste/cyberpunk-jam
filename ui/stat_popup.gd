...
func pop():
	match get_node("../").id:
		...
		8: # keylogger
			...
			$PopUp/RichTextLabel.text = "Your main source of income. Generates money while alive but has almost no HP and does no damage to the server."
